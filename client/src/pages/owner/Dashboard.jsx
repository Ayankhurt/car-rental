...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title='Admin Dashboard' subTitle='Monitor overall platform performance including total cars, bookings, revenue, and activites' />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs' >
          ...
          <p className='text-3xl m-6 font-semibold text-primary'>{currency} {data.monthlyRevenue}</p>
        </div>
      </div>
    </div>
  )
