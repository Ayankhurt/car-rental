...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <Title title="Add New Car" subTitle='Fill in details to list a new car for booking, including pricing, availablity, and car specifications.' />
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. XS, E-Class, M4...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e => setCar({ ...car, model: e.target.value })} />
          </div>
        </div>
        ...
        {/* car transmission fuel type seating seating_capacity */}
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea rows={5} placeholder='e.g. A luxurious with a spacious interior nd a powerful engine.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e => setCar({ ...car, description: e.target.value })}> </textarea>
        </div>
